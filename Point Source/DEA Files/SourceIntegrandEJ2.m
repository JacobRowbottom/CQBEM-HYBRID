function [f] = SourceIntegrandEJ2(s,xa,ya,za,xb,yb,zb,Ox,Oy,Oz,Damp,ThetaLoc,ThetaStep)
...
%pwl
%CosThetaCut=(abs(ThetaLoc-Theta0)<ThetaStep).*(ThetaStep-abs(ThetaLoc-Theta0)).*CosTheta0/ThetaStep;
